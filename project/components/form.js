...
import { StyleSheet, Text, View,DrawerLayoutAndroid, ToolbarAndroid,ImageBackground,TextInput,Dimensions,TouchableOpacity,Image } from 'react-native';
...
export class FormContact extends Component {
    render() {
        return (
            <View style={styles.formContainer}>
                <ImageBackground source={require("../assets/images/contactbg.png")} style={styles.bgImage}>
                <View style={styles.loginForm}>
